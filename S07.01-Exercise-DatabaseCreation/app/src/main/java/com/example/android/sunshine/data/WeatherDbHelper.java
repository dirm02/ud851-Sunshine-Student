...
//  TODO (15) Override onCreate and create the weather table from within it
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_WEATHER_DATABASE = "CREATE TABLE" + WeatherContract.WeatherEntry.TABLE_NAME
                                                    + "(" + WeatherContract.WeatherEntry.COLUMN_WEATHER_ID +
                " INTEGER PRIMARY KEY AUTOINCREMENT," + WeatherContract.WeatherEntry.COLUMN_DATE +
                " INTEGER," + WeatherContract.WeatherEntry.COLUMN_MIN_TEMP + " INTEGER,"
