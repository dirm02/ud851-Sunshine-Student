    ...
    // TODO (7) Override the onPostExecute method to display the results of the network request
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try{
                ...
                String[] simpleJsonWeatherResponse = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonWeatherResponse);
                return simpleJsonWeatherResponse;
            } catch (Exception e){
                e.printStackTrace();
                return null;
            }
