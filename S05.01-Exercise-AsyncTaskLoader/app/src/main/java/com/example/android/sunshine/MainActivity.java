...
private static final int FORECAST_LOADER_ID = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int LOADER_ID =FORECAST_LOADER_ID;
        LoaderManager.LoaderCallbacks<String> callback = MainActivity.this;
        Bundle bundleForLoader = null;
        /* Once all of our views are setup, we can load the weather data. */
        getSupportLoaderManager().initLoader(LOADER_ID,bundleForLoader, (android.support.v4.app.LoaderManager.LoaderCallbacks<Object>) callback);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            invalidateData();
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID,null, (android.support.v4.app.LoaderManager.LoaderCallbacks<Object>) this);
            return true;
        }
