...
//      TODO (13) Find each of the TextViews by ID
        ...
        mHumidity = (TextView) findViewById(R.id.detail_humidity);
        mhigh = (TextView) findViewById(R.id.detail_high_temp);
        mLow = (TextView) findViewById(R.id.detail_low_tmp);
       ...
       getSupportLoaderManager().initLoader(ID_DETAIL_LOADER,null, (LoaderManager.LoaderCallbacks<Object>) this);
