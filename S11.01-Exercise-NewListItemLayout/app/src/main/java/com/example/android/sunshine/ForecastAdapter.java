...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
       ...
       forecastAdapterViewHolder.weatherIconView.setImageResource(weatherId);
       ...
       String hightString = SunshineWeatherUtils.formatTemperature(mContext,highInCelsius);

       String high_A11y = mContext.getString(R.string.a11y_high_temp);
       forecastAdapterViewHolder.highTempView.setText(hightString);
       forecastAdapterViewHolder.highTempView.setContentDescription(high_A11y);
