...
// completed TODO (2) Remove all the TextView declarations
...
//      completed TODO (5) Remove all the findViewById calls
...
//      TODO (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryINfo.weatehrContentDescription.setText(descriptionA11y);
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryInfo.hightTemperature.setText(highString);
