...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String defaultForUnits = context.getString(R.string.pref_units_metric);
        String preferredUnits = pref.getString(keyForUnits,defaultForUnits);
        String metrics = context.getString(R.string.pref_units_metric);
        boolean userPrefersMetrics;
        if(metrics.equals(preferredUnits)){
                userPrefersMetrics = true;
        }
        else{
            userPrefersMetrics = false;
        }
        /** This will be implemented in a future lesson **/
        return userPrefersMetrics;
    }
